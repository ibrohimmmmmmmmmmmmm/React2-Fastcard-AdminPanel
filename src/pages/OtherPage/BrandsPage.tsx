...
export default function BrandsPage() {
  ...
  // ✅ FIXED: correct typing + no res.data issue
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        if (selectedBrand) {
          await updateBrand(selectedBrand.id, values.brandName)
        } else {
          await addBrand(values.brandName)
        }
                ...
                <TableRow key={b.id}>
                  ...
                  <TableCell className="text-right">
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        deleteBrand(b.id).then(fetchBrands)
                      }
                    >
